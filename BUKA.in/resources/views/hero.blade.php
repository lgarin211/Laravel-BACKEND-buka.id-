...
<body>
							...
							<div class="col-md-12">
								<div class="mu-single-slide-content">
									...
									<p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula
										eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient
										montes, nascetur ridiculus mus. Donec quam felis,</p>
									<a class="mu-primary-btn" href="#">Mulai.in <span
											class="fas fa-sign-in-alt"></span></a>
								</div>
							</div>
						</div>
										...
										<div class="row">
											...
											<div class="col-md-4">
												<div class="mu-single-service">
													<div class="mu-single-service-icon"><i class="fas fa-shopping-cart"
											...
											<div class="col-md-4">
												<div class="mu-single-service">
													<div class="mu-single-service-icon"><i class="far fa-grin-alt"
															aria-hidden="true"></i></div>
													<div class="mu-single-service-content">
	...
	<script type="text/javascript" src="vendor/js/jquery.filterizr.min.js"></script>
	<!-- Gallery Lightbox -->
	<script type="text/javascript" src="vendor/js/jquery.magnific-popup.min.js"></script>
	<!-- Counter js -->
	<script type="text/javascript" src="vendor/js/counter.js"></script>
	<!-- Ajax contact form  -->
